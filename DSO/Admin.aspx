<%@ Page Title="" Language="C#" MasterPageFile="~/DSO.Master" AutoEventWireup="true" CodeBehind="Admin.aspx.cs" Inherits="DSO.Admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        ...
        <div class="table-responsive">
            <asp:GridView ID="gvApplications" runat="server" AutoGenerateColumns="false" CssClass="table table-striped" BorderStyle="NotSet">
                <Columns>
